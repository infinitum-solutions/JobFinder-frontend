...
const appRoutes: Routes = [
  ...
  {path: 'organizations/:uuid', component: OrganizationProfileComponent},
  {path: 'publications', component: PublicationListComponent},
  {path: 'publications/create', component: PublicationCreateComponent},
  {path: 'publications/:uuid', component: PublicationComponent},
  {path: 'publications/:uuid/edit', component: PublicationEditComponent},
